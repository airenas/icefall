...
"""
This file computes fbank features of the liepa3 dataset.
...
def compute_fbank_liepa3(
    ...
    # prefix = "liepa3"
    suffix = "jsonl.gz"
    cuts_files = {part: src_dir / f"cuts_{part}.{suffix}" for part in dataset_parts}
    ...
    with get_executor() as ex:  # Initialize the executor only once.
        for partition, cuts_file in cuts_files.items():
