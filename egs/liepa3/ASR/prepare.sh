...
if [ $stage -le 1 ] && [ $stop_stage -ge 1 ]; then
  log "Stage 1: Prepare liepa3 manifest"
  # We assume that you have downloaded the liepa3 corpus
  # to $dl_dir/
...
#   if [ ! -f $dl_dir/lm/liepa3-lexicon.txt ]; then
...
#       cat - $dl_dir/lm/liepa3-lexicon.txt |
