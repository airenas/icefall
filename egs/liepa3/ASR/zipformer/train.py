...
def run(rank, world_size, args):
    ...
    liepa3 = Liepa3AsrDataModule(args)

    train_cuts = liepa3.train_cuts()
    ...
    train_dl = liepa3.train_dataloaders(
        train_cuts, sampler_state_dict=sampler_state_dict
    )

    valid_cuts = liepa3.dev_cuts()
    valid_dl = liepa3.valid_dataloaders(valid_cuts)
